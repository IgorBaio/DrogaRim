 ...
 * @author mathe
 */
public class PesquisaProdutoVendidoController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(PesquisaProdutoVendidoController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
